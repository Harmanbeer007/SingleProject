...
public class BusTrackAdapter extends RecyclerView.Adapter<BusTrackAdapter.MyHoder> {

    List<BusInfoparent> list;
    Context context;
    String college;

    public BusTrackAdapter(List<BusInfoparent> list, Context context, String user) {
