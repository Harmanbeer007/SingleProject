...
//    private EditText mDriverEditText;
...
//        mDriverEditText = (EditText) findViewById(R.id.driverId);
...
//        String driverid = mPrefs.getString(getString(R.string.driverId), "");
//        String password = mPrefs.getString(getString(R.string.password), "");
//
//        mCollegeIdEditText.setText(transportID);
//        mDriverEditText.setText(driverid);
...
//        } else if (transportID.length() > 0 && driverid.length() > 0 && password.length() > 0) {
...
//            mDriverEditText.setText(getString(R.string.build_email));
...
//        mCollegeIdEditText.setEnabled(!tracking);
//        mDriverEditText.setEnabled(!tracking);
...
//        if (mCollegeIdEditText.length() == 0 || mDriverEditText.length() == 0 ||
...
//            editor.putString(getString(R.string.driverId), mDriverEditText.getText().toString());
...
//        mSwitch.setEnabled(mCollegeIdEditText.length() > 0 && mDriverEditText.length() > 0 &&
//                mPasswordEditText.length() > 0);
...
//                        mCollegeIdEditText.setEnabled(true);
//                        mDriverEditText.setEnabled(true);
...
//        super.onDestroy();
//
//            startService(new Intent(this, TrackerService.class)); // add this line
//
//
//    }
//}
